...
export default function LandingPage() {
  return (
    <div className="flex-1  min-h-screen  w-full">
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                <h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl lg:text-6xl">
                  通过<span className="text-blue-500"> 敏捷之道 </span>提升您的团队效率
                </h1>
        ...
        {/* Product Features */}
        <section id="product-features" className="  py-16 md:py-28 lg:py-36 bg-gray-50 dark:bg-gray-800">
        ...
        <section id="features" className="w-full mx-auto py-12 md:py-24 lg:py-32 ">
          <div className=" px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl text-center mb-12"><span className="text-blue-500"> 敏捷之道 </span> 的主要特点</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 container mx-auto">
              <Card>
                <CardContent className="flex flex-col items-center p-6">
                  <CheckCircle className="h-12 w-12 mb-4 text-green-500" />
        ...
        <section id="why-scrum" className="w-full py-16 md:py-24 lg:py-32 bg-gray-50 dark:bg-gray-800">
          <div className=" px-4 sm:px-6 md:px-8">
            <h2 className="text-3xl font-bold tracking-tight text-center mb-8 sm:text-4xl md:text-5xl">为什么选择 <span className="text-blue-500"> 敏捷之道 </span>？</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8   container mx-auto">
              <div className="flex flex-col space-y-4 p-6 bg-white border border-gray-200 dark:border-gray-700 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 container mx-auto">
              <Card>
                <CardContent className="p-6">
                  <p className="mb-4 italic">"采用 敏捷之道 后，我们的产品交付速度提升了 40%，客户满意度显著提高。"</p>
                  <p className="font-bold">- Jhonny，技术总监</p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="p-6">
                  <p className="mb-4 italic">"敏捷之道 使我们能够更高效地管理复杂产品开发，显著减少了交付延期。"</p>
                  <p className="font-bold">- William，项目经理</p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="p-6">
                  <p className="mb-4 italic">"使用 敏捷之道 后，团队在产品开发中的协作更紧密，创新氛围更浓厚。"</p>
          ...
          <div className=" px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              ...
              <p className="mx-auto max-w-[600px] text-primary-foreground/90 md:text-xl">
                立即使用 <span className="text-white"> 敏捷之道 </span>，开启敏捷开发的全新篇章。
              </p>
              <Link href="/workspace">
